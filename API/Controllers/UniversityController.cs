...
public class UniversityController : GenericAllController<University>
{
    ...
    /* //Non Generic
     private readonly IAllRepository<University> _universityRepository;

     public UniversityController(IAllRepository<University> universityRepository)
     {
