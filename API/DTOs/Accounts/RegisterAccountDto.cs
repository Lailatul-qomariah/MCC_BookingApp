...
namespace API.DTOs.Accounts
{
    ...
    // Representasi DTO untuk register yang akan input di beberapa tabel sekaligus 
    {
        ...
        public static implicit operator Employee(RegisterAccountDto registrationDto)
        {
            return new ()
            {
        ...
        public static implicit operator University(RegisterAccountDto registrationDto)
        {
            return new ()
            {
        ...
        public static implicit operator Education(RegisterAccountDto registrationDto)
        {
            return new ()
            {
                Guid = Guid.NewGuid(),
